# Philippine Payroll Management System - Documentation Index

## Project Overview

A comprehensive payroll management system designed for small-medium organizations (100-200 employees) in the Philippines, featuring:

- **Frontend**: Vue 3 + Vuetify
- **Backend**: Laravel REST API
- **Database**: PostgreSQL
- **Deployment**: Electron desktop app with mobile admin access
- **Special Features**: Offline-first capability, Philippine payroll compliance
