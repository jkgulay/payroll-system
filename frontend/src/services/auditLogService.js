...
export const auditLogService = {
  ...
  getAvailableActions() {
    return [
      ...
      { value: 'reprocess_payroll', text: 'Reprocess Payroll', color: 'warning' },
      { value: 'delete_payroll', text: 'Delete Payroll', color: 'error' },
      { value: 'payroll_punch_review', text: 'Payroll Punch Review', color: 'indigo' },
      { value: 'payroll_overtime_attendance_view', text: 'View Overtime Attendance', color: 'teal' },
      { value: 'payroll_overtime_employees_set', text: 'Set Overtime-Eligible Employees', color: 'cyan' },
      { value: 'payroll_overtime_employees_updated', text: 'Update Overtime-Eligible Employees', color: 'cyan' },
      { value: 'update_attendance', text: 'Update Attendance', color: 'blue' },
      { value: 'update_attendance_overtime', text: 'Update Attendance Overtime', color: 'deep-orange' },
      { value: 'manual_attendance_entry', text: 'Manual Attendance Entry', color: 'purple' },
