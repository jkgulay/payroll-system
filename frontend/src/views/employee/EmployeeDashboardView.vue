      ...
      <v-col cols="12" sm="6" md="3">
        <v-card class="hover-card" @click="scrollToSection('payslip')">
          <v-card-text class="text-center pa-6">
            ...
            <div class="text-caption text-medium-emphasis">Latest payment</div>
          </v-card-text>
        </v-card>
      </v-col>
      <v-col cols="12" sm="6" md="3">
        <v-card class="hover-card" @click="scrollToSection('history')">
          <v-card-text class="text-center pa-6">
            <v-icon size="48" color="warning" class="mb-2">mdi-history</v-icon>
      ...
      <v-col cols="12" sm="6" md="3">
        <v-card class="hover-card" @click="downloadCurrentPayslip">
          <v-card-text class="text-center pa-6">
            ...
            <div class="text-caption text-medium-emphasis">Export payslip</div>
          </v-card-text>
        </v-card>
      </v-col>
    </v-row>
          ...
          <v-card-text>
            <div v-if="currentPayslip">
              <v-list>
                ...
                <v-list-item>
                  <v-list-item-title class="text-h6">Net Pay</v-list-item-title>
              ...
              >
                ...
                <template v-slot:append>
                  <v-menu>
                    ...
                    <v-list>
                      <v-list-item @click="downloadPayslip(payslip.id, 'pdf')">
                        <v-list-item-title>
                          <v-icon size="small" class="mr-2">mdi-file-pdf-box</v-icon>
                          PDF
                        </v-list-item-title>
                      </v-list-item>
                      <v-list-item @click="downloadPayslip(payslip.id, 'excel')">
                        <v-list-item-title>
                          <v-icon size="small" class="mr-2">mdi-microsoft-excel</v-icon>
                          Excel
                        </v-list-item-title>
                      </v-list-item>
                    </v-list>
