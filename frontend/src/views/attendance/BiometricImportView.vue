    ...
    <v-card>
      ...
      <v-card-text>
        <v-alert type="info" variant="tonal" class="mb-4">
          ...
          <ol>
            <li>
              <strong>Step 1:</strong> Import Staff Information (employee data)
            </li>
            <li>
              <strong>Step 2:</strong> Import Punch Records (attendance data)
            </li>
          </ol>
          <p class="mt-2 text-body-2">
            This ensures staff codes are registered before importing their
            attendance.
          </p>
        </v-alert>
        ...
        <v-card variant="outlined" class="mb-4">
          ...
          <v-card-text class="pt-4">
            <v-alert type="info" variant="tonal" class="mb-4">
              ...
              <strong>Optional:</strong> User ID, Email, Mobile No, Gender,
              Entry Date, Entry Status, Position, Department, Staff Type<br />
              <strong>Field Mapping:</strong>
              <ul class="mt-2">
                <li>
                  <strong>Staff Type →</strong> Will be saved as
                  <strong>Position</strong> (job role)
                </li>
                <li>
                  <strong>Department →</strong> Will be mapped to
                  <strong>Project</strong> (creates project if not exists)
                </li>
              </ul>
              <strong>Format:</strong> Excel (.xls, .xlsx)
            </v-alert>

            <!-- Bulk Defaults for Missing Data -->
            <v-card variant="outlined" class="mb-4">
              ...
              <v-card-text>
                <p class="text-body-2 text-medium-emphasis mb-3">
                  Apply these defaults to staff without Position or Project data
                </p>
                <v-row>
                  <v-col cols="12" md="6">
                    <v-autocomplete
                      ...
                      density="compact"
                      clearable
                      hint="For staff without Staff Type or Position"
                      persistent-hint
                    >
                  ...
                  <v-col cols="12" md="6">
                    <v-autocomplete
                      ...
                      density="compact"
                      clearable
                      hint="For staff without Department"
                      persistent-hint
                    >
                      <template v-slot:prepend-inner>
            ...
            >
              ...
              <p class="text-h6 mt-4">
                {{
                  staffFile
                    ? staffFile.name
                    : "Drop staff information file here or click to browse"
                }}
              </p>
            ...
            >
              ...
              >
                ...
                <ul>
                  <li
                    v-for="(error, index) in staffImportResult.errors.slice(
                      0,
                      10,
                    )"
                    :key="index"
                  ...
                  <li v-if="staffImportResult.errors.length > 10">
                    ... and {{ staffImportResult.errors.length - 10 }} more
                    errors
                  </li>
                </ul>
              </div>
        ...
        <v-card variant="outlined">
          <v-card-title class="bg-secondary">
            ...
            Import Punch Records (Attendance)
          </v-card-title>
          <v-card-text class="pt-4">
            <v-alert type="warning" variant="tonal" class="mb-4">
              <strong>Important:</strong> Complete Step 1 first to ensure all
              staff codes are registered!
            </v-alert>

            <v-alert type="info" variant="tonal" class="mb-4">
              <strong>Required columns:</strong> Staff Code, Name, Date columns
              (MM-DD format)<br />
              <strong>Time format:</strong> HH:MM (e.g., 08:30), multiple times
              per day<br />
              <strong>Format:</strong> Excel (.xls, .xlsx)
            </v-alert>
            ...
            >
              ...
              <p class="text-h6 mt-4">
                {{
                  punchFile
                    ? punchFile.name
                    : "Drop punch records file here or click to browse"
                }}
              </p>
              <p class="text-caption text-medium-emphasis">
                Supported formats: .xls, .xlsx
            ...
            >
              ...
              <div
                v-if="
                  punchImportResult.errors &&
                  punchImportResult.errors.length > 0
                "
                class="mt-2"
              >
                <p class="font-weight-bold">Errors:</p>
                <ul>
                  <li
                    v-for="(error, index) in punchImportResult.errors.slice(
                      0,
                      10,
                    )"
                    :key="index"
                  ...
                  <li v-if="punchImportResult.errors.length > 10">
                    ... and {{ punchImportResult.errors.length - 10 }} more
                    errors
                  </li>
                </ul>
              </div>
          ...
          <v-expansion-panels>
            <v-expansion-panel>
              ...
              <v-expansion-panel-text>
                <p>
                  <strong>Description:</strong> Import staff/employee
                  information from biometric device
                </p>
            ...
            <v-expansion-panel>
              ...
              <v-expansion-panel-text>
                <p>
                  <strong>Description:</strong> Import attendance punch records
                  with date-based columns
                </p>
                <p><strong>Required Columns:</strong></p>
                <ul>
                  <li>Staff Code</li>
                ...
                <p>
                  <strong>Multiple Times:</strong> Separate by newlines within
                  the cell
                </p>
                ...
                <ul>
                  ...
                  <li>
                    <strong>Month:</strong> Optional - Override the month from
                    date columns
                  </li>
                </ul>
              </v-expansion-panel-text>
