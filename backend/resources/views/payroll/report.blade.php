        ...
        <tbody>
            ...
            @foreach($payslips as $payslip)
                @php
                    ...
                    $totalSSS += $payslip->sss_contribution ?? 0;
                    $totalPhilHealth += $payslip->philhealth_contribution ?? 0;
                    $totalPagIBIG += $payslip->pagibig_contribution ?? 0;
                ...
                <tr>
                    ...
                    <td class="text-right">₱{{ number_format($payslip->sss_contribution ?? 0, 2) }}</td>
                    <td class="text-right">₱{{ number_format($payslip->philhealth_contribution ?? 0, 2) }}</td>
                    <td class="text-right">₱{{ number_format($payslip->pagibig_contribution ?? 0, 2) }}</td>
