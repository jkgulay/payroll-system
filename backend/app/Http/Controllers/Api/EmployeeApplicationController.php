...
class EmployeeApplicationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'employment_status' => 'required|in:regular,probationary,contractual,active',
    ...
    public function approve(Request $request, $id)
    {
        ...
        try {
            ...
            $employee = Employee::create([
                ...
                'has_water_allowance' => $application->has_water_allowance,
                'water_allowance' => $application->water_allowance,
                'has_cola' => $application->has_cola,
                'cola' => $application->cola,
                'has_incentives' => $application->has_incentives,
                'incentives' => $application->incentives,
                'has_ppe' => $application->has_ppe,
                'ppe' => $application->ppe,
                'is_active' => true,
            ]);
