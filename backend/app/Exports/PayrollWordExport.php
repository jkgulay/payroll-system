...
class PayrollWordExport
{
    ...
    public function generate()
    {
        ...
        foreach ($this->items as $index => $item) {
            ...
            $table->addRow(280);
            $table->addCell(1800)->addText(($index + 1) . '. ' . ($item->employee->full_name ?? ''), $cellStyle, ['alignment' => 'left']);
            $table->addCell(700)->addText(number_format($rate, 2), $cellStyle, ['alignment' => 'right']);
            $table->addCell(600)->addText($this->formatDays($daysWorked), $cellStyle, ['alignment' => 'center']);
            $table->addCell(900)->addText(number_format($amount, 2), $cellStyle, ['alignment' => 'right']);
            $table->addCell(600)->addText($item->regular_ot_hours > 0 ? $item->regular_ot_hours : '', $cellStyle, ['alignment' => 'center']);
            $table->addCell(600)->addText($item->regular_ot_pay > 0 ? number_format($item->regular_ot_pay, 2) : '', $cellStyle, ['alignment' => 'right']);
            $table->addCell(600)->addText($item->special_ot_hours > 0 ? $item->special_ot_hours : '', $cellStyle, ['alignment' => 'center']);
            $table->addCell(600)->addText($item->special_ot_pay > 0 ? number_format($item->special_ot_pay, 2) : '', $cellStyle, ['alignment' => 'right']);
            $table->addCell(900)->addText($item->salary_adjustment != 0 ? number_format($item->salary_adjustment, 2) : '', $cellStyle, ['alignment' => 'right']);
            $table->addCell(800)->addText($item->other_allowances > 0 ? number_format($item->other_allowances, 2) : '', $cellStyle, ['alignment' => 'right']);
            $table->addCell(900)->addText(number_format($item->gross_pay ?? 0, 2), $cellStyle, ['alignment' => 'right']);
            $table->addCell(900)->addText($item->employee_savings > 0 ? number_format($item->employee_savings, 2) : '', $cellStyle, ['alignment' => 'right']);
            $table->addCell(700)->addText($item->loans > 0 ? number_format($item->loans, 2) : '', $cellStyle, ['alignment' => 'right']);
            $table->addCell(600)->addText($undertimeDeduction > 0 ? number_format($undertimeDeduction, 2) : '', $cellStyle, ['alignment' => 'right']);
            $table->addCell(800)->addText($item->employee_deductions > 0 ? number_format($item->employee_deductions, 2) : '', $cellStyle, ['alignment' => 'right']);
            $table->addCell(700)->addText($item->philhealth > 0 ? number_format($item->philhealth, 2) : '', $cellStyle, ['alignment' => 'right']);
            $table->addCell(700)->addText($item->pagibig > 0 ? number_format($item->pagibig, 2) : '', $cellStyle, ['alignment' => 'right']);
            $table->addCell(700)->addText($item->sss > 0 ? number_format($item->sss, 2) : '', $cellStyle, ['alignment' => 'right']);
            $table->addCell(900)->addText(number_format($item->net_pay ?? 0, 2), $cellStyle, ['alignment' => 'right']);
        ...
        $table->addRow(250);
        $table->addCell(15200, ['gridSpan' => 20])->addText('nothing follows', ['italic' => true, 'size' => 7, 'name' => 'Arial'], ['alignment' => 'center']);
        ...
        $table->addRow(280);
        $table->addCell(1800)->addText('T O T A L', $totalStyle, ['alignment' => 'left']);
        $table->addCell(700)->addText('', $totalStyle);
        $table->addCell(600)->addText('', $totalStyle);
        $table->addCell(900)->addText(number_format($totalAmount, 2), $totalStyle, ['alignment' => 'right']);
        $table->addCell(600)->addText($totalRegOtHours > 0 ? $totalRegOtHours : '', $totalStyle, ['alignment' => 'center']);
        $table->addCell(600)->addText(number_format($totalRegOtPay, 2), $totalStyle, ['alignment' => 'right']);
        $table->addCell(600)->addText($totalSpeOtHours > 0 ? $totalSpeOtHours : '', $totalStyle, ['alignment' => 'center']);
        $table->addCell(600)->addText(number_format($totalSpeOtPay, 2), $totalStyle, ['alignment' => 'right']);
        $table->addCell(900)->addText(number_format($totalSalaryAdjustment, 2), $totalStyle, ['alignment' => 'right']);
        $table->addCell(800)->addText(number_format($totalAllowances, 2), $totalStyle, ['alignment' => 'right']);
        $table->addCell(900)->addText(number_format($totalGross, 2), $totalStyle, ['alignment' => 'right']);
        $table->addCell(900)->addText(number_format($totalEmployeeSavings, 2), $totalStyle, ['alignment' => 'right']);
        $table->addCell(700)->addText(number_format($totalLoans, 2), $totalStyle, ['alignment' => 'right']);
        $table->addCell(600)->addText($totalUndertimeDeduction > 0 ? number_format($totalUndertimeDeduction, 2) : '', $totalStyle, ['alignment' => 'right']);
        $table->addCell(800)->addText(number_format($totalEmployeeDeductions, 2), $totalStyle, ['alignment' => 'right']);
        $table->addCell(700)->addText(number_format($totalPhilhealth, 2), $totalStyle, ['alignment' => 'right']);
        $table->addCell(700)->addText(number_format($totalPagibig, 2), $totalStyle, ['alignment' => 'right']);
